function largestProduct(aa) {
    ...
    // returns the value of the element in a 2d array for the given row and column.
    ...
    console.log(aa[row1][col1], "*", aa[row2][col2], "=", largest); // 88 * 99 = 8712
    return largest;
}
...
console.log(largestProduct(aa)); // 8712