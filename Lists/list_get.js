...
console.log("contains?", ll.contains(9)); // true
console.log("contains?", ll.contains(19)); // true
console.log("contains?", ll.contains(44)); // false

ll.remove(ll.size - 1);
console.log("contains?", ll.contains(19)); // false